...
export class Account
{
	...
	getSession = async (username = this.base.username, password = this.base.password, uuid: string | undefined = undefined) => //! If you send 6 getSession() with invalid password, the account will be LOCKED
	{
